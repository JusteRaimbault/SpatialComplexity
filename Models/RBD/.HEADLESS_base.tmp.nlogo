...
patches-own[
  ...
  p-distance-to-roads-coefficient
  p-distance-to-center-coefficient
  p-distance-to-activities-coefficient
  pw
  pdists
...
498
hide/show corr nw
ask corr-links [set hidden? not hidden?] ask corr-nodes [set hidden? not hidden?]\n;ask corr-links with [corr-link:weight < 0.9][set hidden? true]
NIL
1
T
OBSERVER
